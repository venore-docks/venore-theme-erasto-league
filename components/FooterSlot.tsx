...
// Footer normal (respeita light/dark como o resto do conteúdo) — a identidade fica só na rail
// (Rail.tsx); repetir o mesmo chrome aqui pesaria a página com cor demais (era parte do motivo
// de "parecer casa de aposta").
